...
public class PlanEstudioView {
    ...
    private void actualizarPlan() {
        ...
        String tituloOriginal = plan.getTitulo();
        String duracionOriginal = plan.getDuracion();
        String anioOriginal = plan.getAnio();
        List<Materia> materiasOriginales = plan.getMaterias() != null ? new ArrayList<>(plan.getMaterias()) : null;
        ...
        if (confirmarAccion("¿Guardar cambios?")) {
            ...
            plan.setTitulo(tituloOriginal);
            plan.setDuracion(duracionOriginal);
            plan.setAnio(anioOriginal);
            plan.setMaterias(materiasOriginales);
