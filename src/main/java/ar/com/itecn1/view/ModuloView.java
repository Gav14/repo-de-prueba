...
public class ModuloView {
    ...
    private void actualizarModulo() {
        ...
        // Guardar originales antes de aplicar cambios para la vista previa
        LocalTime inicioOriginal = m.getInicio();
        LocalTime finOriginal = m.getFin();
        ...
        if (confirmarAccion("¿Guardar cambios?")) {
            ...
            m.setInicio(inicioOriginal);
            m.setFin(finOriginal);
