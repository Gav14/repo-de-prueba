...
public class CuatrimestreView {
    ...
    private void actualizarCuatrimestre() {
        ...
        System.out.println("\nVista previa:");
        System.out.println("Año: "            + (nuevoAnio.isEmpty()   ? c.getAnio()   : nuevoAnio));
        System.out.println("Fecha de inicio: "+ (nuevoInicio.isEmpty() ? c.getInicio() : LocalDate.parse(nuevoInicio)));
        System.out.println("Fecha de fin: "   + (nuevoFin.isEmpty()    ? c.getFin()    : LocalDate.parse(nuevoFin)));
